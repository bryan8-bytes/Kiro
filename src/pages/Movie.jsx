  ...
  return (
    <div className="h-screen w-full relative overflow-hidden text-slate-800 font-sans pt-20 pb-6 flex flex-col">
      ...
      <div className="relative z-10 w-full max-w-[98vw] 2xl:max-w-[1800px] mx-auto px-2 sm:px-6 flex-1 min-h-0 flex flex-col items-center">
        ...
        >
          <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-2xl bg-gradient-to-br from-sky-300 to-pink-300 flex items-center justify-center shadow-inner group-hover:scale-110 transition-transform">
            <Film className="w-5 h-5 sm:w-6 sm:h-6 text-white" />
          </div>
          <h1 className="text-2xl sm:text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-sky-500 to-pink-500 drop-shadow-sm">
        ...
        >
          <iframe 
            width="100%" 
            height="100%" 
            src="https://www.youtube.com/embed/I5r4zW7RDeY?autoplay=1" 
            title="Cinnamoroll La Pelicula" 
            frameBorder="0" 
